...
@section('content')
    ...
    <div class="bg-white p-6 rounded-3xl shadow-sm border border-gray-100">
            ...
            <div class="flex flex-wrap items-center gap-3 w-full md:w-auto">
                <div class="flex items-center gap-2 bg-gray-50 border border-gray-200 p-1 rounded-xl">
                    <input type="date" id="startDate"
                        class="bg-transparent border-0 text-gray-600 text-sm focus:ring-0 cursor-pointer">
                ...
                <button id="btnFilter"
                    class="bg-blue-600 hover:bg-blue-700 text-white px-5 py-2.5 rounded-xl text-sm font-medium shadow-lg shadow-blue-500/30 transition-all active:scale-95 flex items-center gap-2">
                ...
                <button id="btnReset"
                    class="bg-gray-100 hover:bg-gray-200 text-gray-600 px-4 py-2.5 rounded-xl text-sm font-medium transition-all">
                    Reset
                </button>
            </div>
        </div>
            ...
            <table id="paymentTable" class="w-full text-sm text-left text-gray-500">
                <thead class="text-xs text-gray-700 uppercase bg-gray-50 border-b border-gray-100">
                    <tr>
                        ...
                        <th scope="col" class="px-6 py-4 text-center rounded-tr-xl">Bukti Transfer</th>
                    </tr>
                </thead>
        ...
        <div id="buktiModal"
            class="fixed inset-0 z-[100] hidden items-center justify-center p-4 bg-gray-900/60 backdrop-blur-sm transition-opacity duration-300 opacity-0">
            <div id="modalContent"
                class="bg-white rounded-3xl shadow-2xl w-full max-w-lg overflow-hidden transform scale-95 transition-all duration-300">
                <div class="flex justify-between items-center p-5 border-b border-gray-100 bg-gray-50">
                    <h3 class="font-bold text-gray-800 text-lg">Bukti Transfer</h3>
                    <button onclick="closeBuktiModal()"
                        class="text-gray-400 hover:text-red-500 transition-colors bg-white p-1.5 rounded-full shadow-sm">
                ...
                <div class="p-6 flex justify-center items-center bg-gray-100/50 min-h-[300px]">
                    ...
                    <img id="buktiImage" src="" alt="Bukti Pembayaran"
                        class="max-w-full rounded-xl shadow-md border border-gray-200 hidden"
                        style="max-height: 60vh; object-fit: contain;">

                    <p id="noBuktiText" class="text-gray-500 font-medium hidden">Gagal memuat gambar / format PDF.</p>
                </div>

                <div class="p-4 border-t border-gray-100 flex justify-end bg-white">
                    <button onclick="closeBuktiModal()"
                        class="bg-gray-800 hover:bg-gray-900 text-white px-5 py-2.5 rounded-xl text-sm font-medium transition-all active:scale-95 shadow-md">
                        Tutup
                    </button>
                </div>
            </div>
